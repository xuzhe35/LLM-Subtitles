...
SOURCE=ROOT/'Journey Beyond Self(2).1984193ab268'
DEST=ROOT/'Journey Beyond Self(2).1984193ab268.recovered'
...
result=export_ocr_srt(timeline,index,ocr,evidence,DEST/'Journey Beyond Self(2).ocr.en.srt',language='en',time_offset=0)
