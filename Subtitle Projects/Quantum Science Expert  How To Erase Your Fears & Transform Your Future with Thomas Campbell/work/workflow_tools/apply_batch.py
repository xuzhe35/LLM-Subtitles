...
p=pathlib.Path('Subtitle Projects/Quantum Science Expert  How To Erase Your Fears & Transform Your Future with Thomas Campbell/work');j=pathlib.Path((p/'active-job.txt').read_text());b=pathlib.Path(sys.argv[1]);lines=b.read_text().splitlines();trans={}
for line in lines:
